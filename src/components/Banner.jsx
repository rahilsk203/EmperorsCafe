  ...
  return (
    <div className="bg-white pt-12 md:pt-24 min-h-[500px] items-center">
     ...
     {showVideo && ( <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4">
      ...
      <h3 className="text-lg mt-5 md:text-2xl lg:text-2xl font-bold font-comfortaa text-gray-600 mb-2 md:mb-3">Main denu </h3>
      <h1 className="text-3xl md:text-5xl sm:text-4xl lg:text-7xl xl:text-6xl font-pacifico animate-slide-up font-extrabold leading-tight mb-4"> Claim besr offer on <br />
      ...
      <button className="bg-red-500 text-white px-6 py-2 md:px-6 md:py-3 rounded-full hover:bg-red-600 transition hover:scale-105 text-sm md:text-base">Get Started</button>
      ...
      <img src={Bannerfood} alt="Banner food" className="w-full h-auto object-cover transform -rotate-100 hover:rotate-0 transition duration-500 " />
      ...
      <div className=" absolute right-2 sm:right-6 md:-right-12 top-1/2 transform -translate-y1/2">
